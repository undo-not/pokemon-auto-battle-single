...
| `REQ-DATA-007` | semantic authorityとusage permissionを分離し、source acquisition・235 mapping・Catalog V2 field不足を固定分母で全件監査する | SIM-02C-A Authoritative Intake Contract、凍結V1＋plan/review/mapping/Catalog/assessment/compilation V2 Schemas | `src/champions_sim/authoritative`、`scripts/build_m_b_authoritative_intake.py` | synthetic 57 tests、governance込み70 tests。実M-B V2は5 route全partial、raw payload 2,025 files / 404,113,376 bytes、derived 23、lineage graph gap/missing 15/8、candidate/conflict/verified 219/16/0、required/verified field 8,024/0、宣言済みsurface・既知gap内blocker 10,874、同一compilation hash再生成、Gitignored 5文書 | verified_local V2 workbench, restricted_local, production promotion blocked |
